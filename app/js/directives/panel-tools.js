...
directives.directive('ctPaneltool', function () {
    var templates = {
		...
		refresh: "<a href='' class='btn btn-transparent btn-sm' panel-refresh='' tooltip-placement='top' uib-tooltip='Refresh' data-spinner='{{spinner}}'>" + "<i class='fa fa-circle-o'>o</i>" + "</a>",
		...
		dismiss: "<a href='' class='btn btn-transparent btn-sm' panel-dismiss='' tooltip-placement='top' uib-tooltip='Close'>" + "<i class='ti-close'>X</i>" + "</a>"
    };
...
directives.directive('panelExpand', function ($compile) {
    'use strict';
    return {
        restrict: 'A',
        replace: false,
...
directives.directive('panelRefresh', function () {
    'use strict';
...
directives.directive('panelDismiss', function () {
    'use strict';
    return {
        restrict: 'A',
